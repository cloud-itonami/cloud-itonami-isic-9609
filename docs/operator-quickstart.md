# Operator Quickstart — Other personal service activities n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 9609** (`cloud-itonami-isic-9609`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9609.git
cd cloud-itonami-isic-9609
```
...
- Blueprint governor key: `personal-service-governor`
- Likely source path: `personalservice.governor.cljc`
